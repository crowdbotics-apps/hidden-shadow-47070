"""
Django settings for hidden_shadow_47070 project.
...
ROOT_URLCONF = 'hidden_shadow_47070.urls'
...
WSGI_APPLICATION = 'hidden_shadow_47070.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_shadow_47070 API",
    "DESCRIPTION": "API documentation for hidden_shadow_47070 App",
    "VERSION": "v1",
}
